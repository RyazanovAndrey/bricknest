            ...
            <div className="relative max-w-[800px] flex bg-white">
                ...
                <div className="flex items-center p-8">
                    <div className="space-y-3">
                        ...
                        <input type="text" placeholder='Username' className='w-full border border-line h-10 pl-3 outline-0' />
                        <div className="flex items-center justify-between w-full border border-line">
                            <input type={showPass ? 'text' : 'password'} placeholder='Username' className='h-10 pl-3 outline-0' />
                        ...
                        <button className='bg-main w-full h-10 text-white cursor-pointer'>Login</button>
                ...
                <button onClick={toggleModal} className='absolute top-4 right-4 text-2xl cursor-pointer'>&times;</button>
            </div>
        </div>
    )
}
